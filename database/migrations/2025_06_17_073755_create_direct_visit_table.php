...
public function up()
{
    if (! Schema::hasTable('direct_visit')) {
       Schema::create('direct_visit', function (Blueprint $table) {
        $table->bigIncrements('id');
        $table->string('jabatan_saya',100);
        $table->char('area_code',4);
        $table->char('branch_code',6);
        $table->char('product_code',4);
        $table->char('dealer_code',6);
    ...
    {
        Schema::dropIfExists('direct_visit');
    }
};